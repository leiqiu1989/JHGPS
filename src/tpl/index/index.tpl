<div class="index-header clearfix">    
    ...
    <div class="pull-right userinfo-container">
        ...
        <div class="logout js_changpwd">
            <img src="http://120.25.212.193:8082/JHGPS/src/img/changpwd.png" alt="">
            <span>修改密码</span>
        </div>
        <div class="logout js_logout">
            <img src="http://120.25.212.193:8082/JHGPS/src/img/logout.png" alt="">
            <span>退出</span>
        </div>
    </div>
</div>
                                    ...
                                    <ul class="nav nav-list">
                                        <li class="active"> 
                                            <a href="javascript:" class="dropdown-toggle">
                                                ...
                                                <span class="menu-text">车辆监控</span> 
                                            </a>
                                            <ul class="submenu">
                                                <li class="active"> 
                                                    <a href="#carMonitor/index">车辆监控</a> 
                                                </li>
                                            </ul> 
                                        </li>
                                        <li> 
                                            ...
                                            <ul class="submenu">
                                                <li> 
                                                    <a href="#carManager/index">车辆管理</a> 
                                                </li>
                                            </ul>
                                        </li>
                                        <!--<li>
                                        ...
                                        <li> 
                                            <a href="javascript:" class="dropdown-toggle">
                                                ...
                                                <span class="menu-text">车辆订单配置</span> 
                                            </a>
                                            <ul class="submenu">
                                                <li> 
