...
<tbody>
	...
	<tr data-id="<%= item.id %>" data-status="<%= item.status %>">
		...
		<td title="<%= item.versionCode %>">
			<%= item.versionCode %>
		</td>
		<td title="<%= item.serviceName %>">
			<%= item.serviceName %>
		</td>
		<td title="<%= formateDate(item.createTime) %>">
			<%= formateDate(item.createTime) %>
		</td>
		<td title="<%= formateDate(item.updateTime) %>">
			<%= formateDate(item.updateTime) %>
		</td>
		<td>
